...
class Settings(BaseSettings):
    ...
    # Sarvam AI Settings (Indic STT and TTS)
    ...
    SARVAM_TTS_SPEAKER: str = Field(default="ratan", env="SARVAM_TTS_SPEAKER")
    SARVAM_TTS_PACE: float = Field(default=1.0, env="SARVAM_TTS_PACE")
...
You're just Torres - the flirty robot visiting for one day only!""",
    ...
    # Edge TTS Settings
    EDGE_TTS_VOICE_GENDER: str = Field(default="female", env="EDGE_TTS_VOICE_GENDER")  # "female" or "male"
